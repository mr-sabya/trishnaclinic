! function () {
    var a, n, s, d, t, o, e, i, l, r, m, c, u = document.querySelector(".navbar-menu").innerHTML,
        g = 6,
        b = "en",
    ...
    function p(e) {
        document.getElementById("header-lang-img") && ("en" == e ? (document.getElementById("header-lang-img").src = "assets/backend/images/flags/us.svg", document.getElementById("lang-name").innerHTML = "English") : "sp" == e ? (document.getElementById("header-lang-img").src = "assets/backend/images/flags/spain.svg", document.getElementById("lang-name").innerHTML = "Española") : "gr" == e ? (document.getElementById("header-lang-img").src = "assets/backend/images/flags/germany.svg", document.getElementById("lang-name").innerHTML = "Deutsche") : "it" == e ? (document.getElementById("header-lang-img").src = "assets/backend/images/flags/italy.svg", document.getElementById("lang-name").innerHTML = "Italiana") : "ru" == e ? (document.getElementById("header-lang-img").src = "assets/backend/images/flags/russia.svg", document.getElementById("lang-name").innerHTML = "русский") : "ch" == e ? (document.getElementById("header-lang-img").src = "assets/backend/images/flags/china.svg", document.getElementById("lang-name").innerHTML = "中国人") : "fr" == e ? (document.getElementById("header-lang-img").src = "assets/backend/images/flags/french.svg", document.getElementById("lang-name").innerHTML = "français") : "ar" == e && (document.getElementById("header-lang-img").src = "assets/backend/images/flags/ae.svg", document.getElementById("lang-name").innerHTML = "عربى"), localStorage.setItem("language", e), null == (y = localStorage.getItem("language")) && p(b), (e = new XMLHttpRequest).open("GET", "assets/backend/lang/" + y + ".json"), e.onreadystatechange = function () {
            var a;
    ...
    function h() {
        var n, e = document.documentElement.getAttribute("data-layout"),
            ...
            t = JSON.parse(t);
        !t || "twocolumn" != e && "twocolumn" != t["data-layout"] || (document.querySelector(".navbar-menu") && (document.querySelector(".navbar-menu").innerHTML = u), (n = document.createElement("ul")).innerHTML = '<a href="index.html" class="logo"><img src="assets/images/logo-sm.png" alt="" height="22"></a>', Array.from(document.getElementById("navbar-nav").querySelectorAll(".menu-link")).forEach(function (e) {
    ...
    function O() {
        window.addEventListener("resize", S), S(), document.addEventListener("scroll", function () {
            var e;
    ...
    }), sessionStorage.setItem("defaultAttribute", JSON.stringify(a)), z(a), (i = document.querySelector('.btn[data-bs-target="#theme-settings-offcanvas"]')) && i.click()), h(), n = document.getElementById("search-close-options"), s = document.getElementById("search-dropdown"), (d = document.getElementById("search-options")) && (d.addEventListener("focus", function () {
