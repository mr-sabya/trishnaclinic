<div>
    <div class="card shadow-sm border-0">
        <div class="card-header d-flex justify-content-between align-items-center bg-white py-3">
            <h5 class="mb-0 fw-bold text-primary"><i class="bi bi-vial me-2"></i>Pathology Units</h5>
        ...
        <div class="card-body">
            ...
            <div class="row mb-3 align-items-center">
                ...
                <div class="col-md-8">
                    ...
                    <div class="alert alert-success py-1 px-3 mb-0 d-inline-block small">
                        {{ session('success') }}
                    </div>
                    @endif
                    @if (session()->has('error'))
                    <div class="alert alert-danger py-1 px-3 mb-0 d-inline-block small">
                        {{ session('error') }}
                    </div>
                    @endif
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle border">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="2" class="text-center py-4 text-muted">No pathology units found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-primary  p-3">
                    <h5 class="modal-title text-white">{{ $unitId ? 'Edit Pathology Unit' : 'Create New Pathology Unit' }}</h5>
                ...
                <form wire:submit.prevent="save">
                    <div class="modal-body p-4">
                        <div class="mb-3">
                            ...
                            <input type="text" wire:model="name" class="form-control @error('name') is-invalid @enderror" placeholder="e.g. mg/dL, mmol/L, cells/mcL">
                            @error('name') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                        <div class="alert alert-info py-2 mb-0">
                            <small><i class="bi bi-info-circle me-1"></i> These units will be available for selection when setting up pathology test parameters.</small>
                        </div>
                    </div>
