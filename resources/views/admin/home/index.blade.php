                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ url('assets/backend/images/users/avatar-10.jpg') }}"
                                                            alt=""
                                                            class="avatar-xs rounded-circle" />
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ url('assets/backend/images/users/avatar-9.jpg') }}"
                                                            alt=""
                                                            class="avatar-xs rounded-circle" />
                                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="bg-info-subtle rounded py-3">
                                            <img src="{{ url('assets/backend/images/products/img-1.png') }}" alt=""
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="bg-warning-subtle rounded py-3">
                                            <img src="{{ url('assets/backend/images/products/img-6.png') }}" alt=""
                                                style="max-height: 215px;max-width: 100%;"
                                                class="mx-auto d-block">
                                        </div>
                                        <div class="pt-3">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="bg-primary-subtle rounded py-3">
                                            <img src="{{ url('assets/backend/images/products/img-8.png') }}" alt=""
                                                style="max-height: 215px;max-width: 100%;"
                                                class="mx-auto d-block">
                                        </div>
                                        <div class="pt-3">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="bg-success-subtle rounded py-3">
                                            <img src="{{ url('assets/backend/images/products/img-5.png') }}" alt=""
                                                style="max-height: 215px;max-width: 100%;"
                                                class="mx-auto d-block">
                                        </div>
                                        <div class="pt-3">
                                ...
                                <div class="vstack gap-3 px-3">
                                    ...
                                    <div class="p-3 border border-dashed rounded-3">
                                        <div class="d-flex align-items-center gap-2">
                                            <div
                                                class="avatar-sm bg-light rounded p-1 flex-shrink-0">
                                                <img src="{{ url('assets/backend/images/products/img-4.png') }}" alt=""
                                                    class="img-fluid d-block">
                                            </div>
                                            <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <div class="p-3 border border-dashed rounded-3">
                                        <div class="d-flex align-items-center gap-2">
                                            <div
                                                class="avatar-sm bg-light rounded p-1 flex-shrink-0">
                                                <img src="{{ url('assets/backend/images/products/img-3.png') }}" alt=""
                                                    class="img-fluid d-block">
                                            </div>
                                            <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <div class="p-3 border border-dashed rounded-3">
                                        <div class="d-flex align-items-center gap-2">
                                            <div
                                                class="avatar-sm bg-light rounded p-1 flex-shrink-0">
                                                <img src="{{ url('assets/backend/images/products/img-9.png') }}" alt=""
                                                    class="img-fluid d-block">
                                            </div>
                                            <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ url('assets/backend/images/products/img-1.png') }}"
                                                            alt=""
                                                            class="avatar-xs rounded-circle" />
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ url('assets/backend/images/products/img-5.png') }}"
                                                            alt=""
                                                            class="avatar-xs rounded-circle" />
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ url('assets/backend/images/products/img-4.png') }}"
                                                            alt=""
                                                            class="avatar-xs rounded-circle" />
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ url('assets/backend/images/products/img-3.png') }}"
                                                            alt=""
                                                            class="avatar-xs rounded-circle" />
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ url('assets/backend/images/products/img-2.png') }}"
                                                            alt=""
                                                            class="avatar-xs rounded-circle" />
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ url('assets/backend/images/products/img-8.png') }}"
                                                            alt=""
                                                            class="avatar-xs rounded-circle" />
                                                    </div>
                    ...
                    <div class="card-body pb-0">
                        ...
                        <ul class="hstack gap-2 chat-panel-list list-unstyled">
                            <li>
                                <a href="#!" class="text-center avatar-sm h-auto d-block">
                                    <div class="chat-user-img online">
                                        <img src="{{ url('assets/backend/images/users/avatar-1.jpg') }}"
                            ...
                            <li>
                                <a href="#!" class="text-center avatar-sm h-auto d-block">
                                    <div class="chat-user-img away">
                                        <img src="{{ url('assets/backend/images/users/avatar-5.jpg') }}"
                                            class="avatar-sm rounded-circle chatlist-user-image"
                                            alt="">
                                        <span class="user-status"></span>
                                    </div>
                        ...
                        <ul class="chat-panel-list list-group list-group-flush mb-0 border-dashed">
                            <li class="list-group-item">
                                <div class="d-flex align-items-center gap-1">
                                    <div class="flex-shrink-0 me-2">
                                        <img src="{{ url('assets/backend/images/users/avatar-1.jpg') }}" alt=""
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center gap-1">
                                    <div class="flex-shrink-0 me-2">
                                        <img src="{{ url('assets/backend/images/users/avatar-2.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle chatlist-user-image" />
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <a href="#!" class="stretched-link">
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center gap-1">
                                    <div class="flex-shrink-0 me-2">
                                        <img src="{{ url('assets/backend/images/users/avatar-3.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle chatlist-user-image" />
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <a href="#!" class="stretched-link">
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center gap-1">
                                    <div class="flex-shrink-0 me-2">
                                        <img src="{{ url('assets/backend/images/users/avatar-4.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle chatlist-user-image" />
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <a href="#!" class="stretched-link">
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center gap-1">
                                    <div class="flex-shrink-0 me-2">
                                        <img src="{{ url('assets/backend/images/users/avatar-5.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle chatlist-user-image" />
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <a href="#!" class="stretched-link">
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center gap-1">
                                    <div class="flex-shrink-0 me-2">
                                        <img src="{{ url('assets/backend/images/users/avatar-6.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle chatlist-user-image" />
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <a href="#!" class="stretched-link">
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center gap-1">
                                    <div class="flex-shrink-0 me-2">
                                        <img src="{{ url('assets/backend/images/users/avatar-7.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle chatlist-user-image" />
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <a href="#!" class="stretched-link">
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center gap-1">
                                    <div class="flex-shrink-0 me-2">
                                        <img src="{{ url('assets/backend/images/users/avatar-8.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle chatlist-user-image" />
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <a href="#!" class="stretched-link">
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center gap-1">
                                    <div class="flex-shrink-0 me-2">
                                        <img src="{{ url('assets/backend/images/users/avatar-9.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle chatlist-user-image" />
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <a href="#!" class="stretched-link">
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center gap-1">
                                    <div class="flex-shrink-0 me-2">
                                        <img src="{{ url('assets/backend/images/users/avatar-10.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle chatlist-user-image" />
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <a href="#!" class="stretched-link">
